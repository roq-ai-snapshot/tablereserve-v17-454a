...
function HomePage() {
  return (
    <>
      <Head>
        <title>TableReserve v17</title>

        <meta
          name="description"
          content="Empower Your Dining Experience with TableReserve v17: Streamline Table Bookings, Manage Customer Preferences, and Optimize Restaurant Occupancy for Unparalleled Efficiency."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Empower Your Dining Experience with TableReserve v17: Streamline Table Bookings, Manage Customer Preferences, and Optimize Restaurant Occupancy for Unparalleled Efficiency.`}
            </Text>
