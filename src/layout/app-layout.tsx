...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Preference', path: '/preferences', entity: 'preference', service: AccessServiceEnum.PROJECT, icon: FiEdit },
  {
    name: 'Reservation',
    path: '/reservations',
    entity: 'reservation',
  ...
  { name: 'Waiter', path: '/waiters', entity: 'waiter', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
